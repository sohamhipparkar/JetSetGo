      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className={`transform transition-all duration-500 ease-out ${animated ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <ul className="space-y-2">
              {['About Us', 'Careers', 'Partners', 'Press'].map((item, index) => (
                <li key={item} className={`transition-all duration-500 ease-out delay-${index * 100}`} style={{ transitionDelay: `${index * 100}ms` }}>
                  <a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors duration-200">{item}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* Destinations Links */}
          <div className={`transform transition-all duration-500 ease-out delay-200 ${animated ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Destinations</h3>
            <ul className="space-y-2">
              {['Europe', 'Asia', 'Americas', 'Africa'].map((item, index) => (
                <li key={item} className="transition-all duration-500 ease-out" style={{ transitionDelay: `${200 + index * 100}ms` }}>
                  <a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors duration-200">{item}</a>
                </li>
              ))}
            </ul>
          ...
          <div className={`transform transition-all duration-500 ease-out delay-400 ${animated ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <ul className="space-y-2">
              {['Help Center', 'Contact Us', 'FAQs', 'Booking Guide'].map((item, index) => (
                <li key={item} className="transition-all duration-500 ease-out" style={{ transitionDelay: `${400 + index * 100}ms` }}>
                  <a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors duration-200">{item}</a>
                </li>
              ))}
            </ul>
          ...
          <div className={`transform transition-all duration-500 ease-out delay-600 ${animated ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <div className="flex space-x-4">
              {/* Social Icons */}
              <a href="#" className="text-gray-500 hover:text-indigo-600 hover:scale-110 transform transition-all duration-200">
        ...
        <div className={`mt-12 pt-8 border-t border-gray-200 text-center text-sm text-gray-500 transition-all duration-700 ease-out delay-800 ${animated ? 'opacity-100' : 'opacity-0'}`}>
          ...
          <div className="mt-4 flex flex-wrap justify-center space-x-6">
            ...
            <a href="#" className="hover:text-indigo-600 transition-colors duration-200">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
